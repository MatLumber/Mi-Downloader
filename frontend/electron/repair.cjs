...
async function fetchText(url) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Strip a UTF-8 BOM. JSON.parse() rejects a leading U+FEFF outright, and
    // anything generated by Windows PowerShell 5.1's `-Encoding utf8` carries
    // one — that is exactly how v1.0.20 shipped a components.json the app
    // could not read.
